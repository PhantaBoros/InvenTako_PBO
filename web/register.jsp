<%-- Document : register Created on : 12 Jun 2026, 14.26.42 Author : Muhammad Sabiq AZ --%>
                    ...
                    <main class="flex-grow flex items-center justify-center p-6 sm:p-12">
                        ...
                        <div class="w-full max-w-[440px] flex flex-col gap-8">
                            ...
                            <div class="text-center">
                                <h1 class="font-headline font-extrabold text-3xl tracking-tighter mb-2"
                                    style="color: #2E5BFF;">InvenTako</h1>
                            </div>

                            <!-- Main Register Card -->
                            <div class="bg-surface-container-lowest rounded-xl p-8 sm:p-10 transition-all duration-300">
                                <header class="mb-8">
                                    <h2 class="font-headline font-bold text-2xl text-on-surface tracking-tight">Create
                                        Account</h2>
                                    <p class="text-on-surface-variant text-sm mt-1">Enter your details to initialize
                                        your account.</p>
                                </header>
                                        ...
                                        <% } %>
                                                    ...
                                                    <% } %>
                                                                ...
                                                                action="AuthServlet?action=register" method="POST"
                                                                id="formRegister">

                                                                <!-- Username Field -->
                                                                <div class="space-y-1.5">
                                                                    <label
                                                                        class="block text-xs font-bold uppercase tracking-widest text-on-surface-variant ml-1"
                                                                        for="username">
                                                                        Username
                                                                    </label>
                                                            ...
                                                            <div class="mt-10 text-center">
                                                                <p class="text-on-surface-variant text-sm font-medium">
                                                                    ...
                                                                    <a class="text-primary font-bold ml-1 hover:underline underline-offset-4 decoration-2"
