...
@WebServlet(name = "ManagerServlet", urlPatterns = {
    "/manager/dashboard", "/manager/barang", "/manager/kasir", "/manager/history", "/manager/history/detail"
})
public class ManagerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/manager/dashboard".equals(path)) {
            ...
            ReportService.ReportData laporan = reportService.generateLaporan(managerId);

            request.setAttribute("transactionList", laporan.transactionList);
            request.setAttribute("topProductList",  laporan.topProducts);
            request.setAttribute("shiftData",       laporan.shiftData);
            request.setAttribute("totalRevenue",    laporan.totalRevenue);
            request.setAttribute("totalCount",      laporan.totalTransaksi);
            request.setAttribute("totalBarang",     laporan.totalBarang);
            request.setAttribute("totalStok",       laporan.totalStok);
        ...
        //Route History
            ...
            request.setAttribute("totalRevenue",    reportService.getTotalRevenue(managerId));
            request.setAttribute("totalCount",      reportService.getTotalTransaksi(managerId));
